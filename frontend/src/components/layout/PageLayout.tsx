...
const PageLayout: React.FC<PageLayoutProps> = ({
  ...
  const layoutClasses = {
    ...
    game: "h-screen flex flex-col gradient-bg game-bg overflow-auto md:overflow-hidden",
  ...
  const mainClasses = {
    ...
    game: "flex-1 flex flex-col md:flex-row gap-2 p-2 overflow-auto md:overflow-hidden",
